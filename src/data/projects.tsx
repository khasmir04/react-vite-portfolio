...
const projects = [
  ...
  },
  {
    title: 'EduKa',
    description:
      'Education management platform using tailwind, nextjs and other libraries, with auth pages.',
    image: eduKaImg,
  ...
  },
  {
    title: 'Mart App',
    description:
      'E-commerce mockup website for SnapMart using tailwind, nextjs.',
    image: martImg,
  ...
  },
  {
    title: 'Game On',
    description:
      'Gaming information website showcasing the use of React, Tailwind, Rapid API and other tools/libraries.',
    image: gamingInfo,
  ...
  },
  {
    ...
    description:
      'A simple application to view 3D objects using React and Three.js.',
